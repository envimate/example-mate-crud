...
package com.envimate.examples.example_mate_crud.infrastructure.db.inmemory;
...
public final class ResourceInMemoryRepository implements ResourceRepository {
    ...
    public void update(final Resource resource) {
        final Resource oldResource = this.db.get(resource.id);
        if (oldResource == null) {
        ...
        if (!oldResource.version.equals(resource.version)) {
            throw new ConcurrentModificationException(String.format(
                    "Version mismatch between existing(%s) and requested(%s)",
                    oldResource,
                    resource
            ));
        }
