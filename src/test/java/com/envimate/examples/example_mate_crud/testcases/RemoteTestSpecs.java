...
public class RemoteTestSpecs implements CreateTestCase, FetchTestCase, UpdateTestCase, ListTestCase {
    private static final String TABLE_NAME = "resource";
    private static final Logger LOGGER = LoggerFactory.getLogger(RemoteTestSpecs.class);
